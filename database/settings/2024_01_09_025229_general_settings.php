...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('general.black_intro_image_id', $black_coffee_default['intro']['image']);
        ...
        $this->migrator->add('general.cappuccino_intro_image_id', $cappuccino_coffee_default['intro']['image']);
        ...
        $this->migrator->add('general.black_video_collab_id', $black_coffee_default['video']['collab']);
        ...
        $this->migrator->add('general.cappuccino_video_collab_id', $cappuccino_coffee_default['video']['collab']);
