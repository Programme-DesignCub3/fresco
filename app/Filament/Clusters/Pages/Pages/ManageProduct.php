...
{
    protected ?string $heading = 'Product';

    protected ?string $subheading = 'Manage the product page settings';
    ...
    {
        $black_image = Media::where('id', $data['pd_black_banner_image_id'])->first();
        $cappuccino_image = Media::where('id', $data['pd_cappuccino_banner_image_id'])->first();

        $data['pd_black_banner_image'] = 'storage/' . $black_image->path;
        $data['pd_cappuccino_banner_image'] = 'storage/' . $cappuccino_image->path;
