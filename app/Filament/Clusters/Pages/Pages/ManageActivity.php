...
class ManageActivity extends SettingsPage
{
    ...
    protected ?string $subheading = 'Manage the activity page settings';
    ...
    {
        $black_image = Media::where('id', $data['ac_black_banner_image_id'])->first();
        $cappuccino_image = Media::where('id', $data['ac_cappuccino_banner_image_id'])->first();

        $data['ac_black_banner_image'] = 'storage/' . $black_image->path;
        $data['ac_cappuccino_banner_image'] = 'storage/' . $cappuccino_image->path;
                            ...
                            Tabs::make('Theme')
                                ->tabs([
                                    ...
                                    Tab::make('Black Coffee Theme')
                                        ->schema([
                                            TextInput::make('ac_black_banner_title')
                                                ->label('Title')
                            ...
                            Tabs::make('Theme')
                                ->tabs([
                                    ...
                                    Tab::make('Cappuccino Theme')
                                        ->schema([
                                            TextInput::make('ac_cappuccino_banner_title')
                                                ->label('Title')
                                                ->rules([new MaxWord('Title', 8, 'en')])
                                                ->autocomplete(false)
                                                ->helperText('Maximum 8 words.')
