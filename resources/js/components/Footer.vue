...
<template>
    <footer
        ...
        <div
            class="fr-container mx-auto flex flex-col justify-between gap-12 px-8 py-20 md:flex-row md:px-0">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div class="space-x-2">
                            ...
                            /></span>
                            <p class="inline-block text-white">0800-1-726867</p>
                        </div>
                        <div class="space-x-2">
                            <span
                                class="rounded-full bg-fr-yellow p-1 text-fr-black"
                        ...
                        <div class="space-x-2">
                            ...
                            /></span>
                            <p class="inline-block text-white">08111 726 867</p>
                        </div>
                        <div class="space-x-2">
                            <span
                                class="rounded-full bg-fr-yellow p-1 text-fr-black"
                                ><v-icon name="fa-line"
                            /></span>
                            <p class="inline-block text-white">@halosantos</p>
                        </div>
                    </div>
                </div>
            </div>
