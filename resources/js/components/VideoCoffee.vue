...
<template>
    <div class="video-coffee py-24" :class="themeStore.theme">
        <div class="fr-container mx-auto w-full px-10 md:px-0">
            <div class="w-full pb-16">
                <iframe
                    v-if="themeStore.theme == 'black'"
                    class="h-[360px] w-full lg:h-[660px]"
                    src="https://www.youtube.com/embed/XPspg1WM2zM"
                    title="Keren! Begini Kompaknya Para Pemain Sepakbola Indonesia Siap Mulai Lagi Harumkan Nama Bangsa"
                    frameborder="0"
                ...
                <iframe
                    v-else
                    class="h-[360px] w-full lg:h-[660px]"
                    src="https://www.youtube.com/embed/QXYyFCfruRg"
                    title="Enaknya Mulai Lagi bersama Kopi Fresco Cappuccino"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    allowfullscreen></iframe>
            </div>
            <div
                class="grid w-full grid-cols-1 grid-rows-3 items-center justify-center md:grid-cols-3 md:grid-rows-1">
