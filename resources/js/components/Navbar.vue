...
<template>
    <header v-if="themeStore.theme != undefined || themeStore.theme != null" class="navigation" id="navigation-sticky"
        :class="[
            themeStore.theme,
            url.pathname == '/'
                ? scroll > 20
        ...
        <div class="navigation-wrapper">
            ...
            <div class="nav-logo">
                <button v-if="url.pathname == '/'" @click="changeThemeHandler">
                    <img width="auto" height="auto" src="/assets/images/logo.png" alt="Fresco" />
                </button>
                <a v-else href="/">
                    <img width="auto" height="auto" src="/assets/images/logo.png" alt="Fresco" />
                </a>
            ...
            <div class="nav-toggle menu cross menu--2">
                <label class="h-[50px] w-[50px] rounded-full">
                    ...
                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        <path class="line--1 stroke-fr-yellow" d="M0 70l28-28c2-2 2-2 7-2h64" />
                        <path class="line--2 stroke-fr-yellow" d="M0 50h99" />
                        <path class="line--3 stroke-fr-yellow" d="M0 30l28 28c2 2 2 2 7 2h64" />
                    </svg>
                </label>
            </div>
            ...
            <div class="nav-list-wrapper" :class="themeStore.openMenu && 'opened'">
                <ul class="nav-list">
                    ...
                    <li class="nav-item" :class="url.pathname == '/aktivitas' && 'nav-active'">
                        <a class="nav-link longer" href="/aktivitas">SERBA-SERBI FRESCO</a>
                    </li>
                    <li class="nav-item" :class="url.pathname == '/hubungi' && 'nav-active'">
                        <a class="nav-link longer" href="/hubungi">HUBUNGI FRESCO</a>
                    </li>
                </ul>
                <!-- Social Media -->
                <div class="nav-socmed-list">
                    <a v-for="social in socials" class="nav-socmed-item"
                        :class="themeStore.theme == 'black' ? 'bg-fr-yellow' : 'bg-fr-green'"
                        :href="social.link ? social.link : '#'" target="_blank">
                        <Icon class="h-9 w-9 pt-2" :class="themeStore.theme == 'black' ? 'text-fr-black' : 'text-white',
        ...
        <Transition name="slide" mode="out-in">
            <div :class="idle ? '-right-40' : 'right-4'" class="float-animate theme-changer"
                v-if="themeStore.theme == 'black'">
                <div class="is-cappuccino" @click="enableCustomLayout('cappuccino')">
                    <img width="auto" height="auto" src="/assets/images/cappuccino-toggler.png" alt="Cappuccino Toggler"
                        class="max-w-full" />
                </div>
            </div>
        </Transition>
        ...
        <Transition name="slide" mode="out-in">
            <div :class="idle ? '-right-40' : 'right-4'" class="float-animate theme-changer"
                ...
                <div class="is-black" @click="enableCustomLayout('black')">
                    <img width="auto" height="auto" src="/assets/images/logo.png" alt="Black Coffee Toggler"
                        class="max-w-full" />
                </div>
            </div>
        </Transition>
