...
<template>
    <header v-if="themeStore.theme == undefined || themeStore.theme == null"
        ...
        <div
            ...
            <div class="absolute bottom-[27%] h-12 w-full bg-gradient-to-t from-[#470610] to-transparent"></div>
            <div class="absolute bottom-[20%] h-12 w-full bg-gradient-to-b from-[#470610] to-transparent"></div>
            <div class="flex flex-col items-center justify-center gap-5 md:gap-6">
                <img width="auto" height="auto" class="mx-auto w-[140px] md:w-[160px] xl:w-[180px]"
                    src="/assets/images/logo.png" alt="Fresco Logo" />
                <h1
                ...
                <div class="relative hidden items-end justify-center lg:flex">
                    <img v-for="d in data" width="auto" height="auto" class="w-[160px] xl:w-[180px]" :src="d.image"
                        :alt="d.product" />
        ...
        <div class="relative flex h-full max-h-[25%] w-full">
            ...
            <button @click="() => {
                ...
                <div class="flex flex-col items-end justify-center gap-3 md:flex-row md:items-center md:gap-6">
                    <span
                        class="flex h-9 w-9 rotate-180 items-center justify-center rounded-full bg-fr-yellow text-fr-black">
                        <Icon class="arrow-slide-fade-right" icon="fa-solid:chevron-right" />
                    </span>
                    <h4
                ...
                <img width="auto" height="auto"
                    ...
                    src="/assets/images/menu-black.png" alt="Black Coffee Theme" />
            </button>
            <!-- Cappuccino Theme -->
            <button @click="() => {
                ...
                <img width="auto" height="auto"
                    ...
                    src="/assets/images/menu-cappuccino.png" alt="Cappuccino Theme" />
                <div
                    ...
                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-fr-red text-white">
                        <Icon class="arrow-slide-fade-right" icon="fa-solid:chevron-right" />
                    </span>
                </div>
            </button>
